...
public class MainBrain {
        ...
        while (true) {
            ...
            for (OneDisc d : discs) {
                ...
                if (d.unused && all_awaiting_clients.size()!=0) {
                    //     System.out.println("Pupa 1");
                    TempFcuking i = get_current_bigest_prior();
                    // System.out.println(i.toString());
                    //    if(i!=null){
                    d.file_size = i.income_file.file_size;
                    String thrName=  "Klient: "+i.klient_id + "\tFile ID: "+i.file_id + "\tFile SIZE: "+i.income_file.file_size;
     ...
     **/
    TempFcuking get_current_bigest_prior() {
...
//        if(klient_id!=-1 && file_id!=-1){
        ...
        return new TempFcuking(real_id,file_id,prior_file);
//        }
//        else
//            return null;
    ...
    //public int TIME_SAVE_ONE_MB = 10;
    //file_size in MB
...
class TempFcuking{
    ...
    public TempFcuking(int klient_id, int file_id, Income_file income_file) {
